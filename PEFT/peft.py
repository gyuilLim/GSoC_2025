...
# NOTE:
#   This file is based on the OpenVINO Training Extensions (OTX) :
...
class DoRALayer(torch.nn.Module):
    ...
    def initialize_magnitude(self, pretrained_weight: torch.Tensor) -> None:
        ...
        with torch.no_grad():
            # Compute norm along input dimension (dim=0)
